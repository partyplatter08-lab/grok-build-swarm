...
pub enum Action {
    ...
    SwitchModel {
        ...
        /// Effort menu option id (`"swarm-heavy"`, `"high"`, …). Distinguishes
        /// multi-agent modes that share wire value `xhigh`.
...
pub enum Effect {
    ...
    SwitchModel {
        ...
        model_id: acp::ModelId,
        effort: Option<ReasoningEffort>,
        /// Effort menu option id for multi-agent modes (Heavy / Swarm / …).
        effort_option_id: Option<String>,
        /// The model that was active before the optimistic UI update
